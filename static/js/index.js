...
const stageBackgrounds = Array.from(
  document.querySelectorAll("[data-stage-bg]"),
);
...
function getPageLang(element = null) {
  const explicitLang =
    element?.dataset?.lang || document.documentElement.lang || "en";
...
function syncContentParagraphsAfter(
  anchor,
  selector,
  paragraphs,
  setup = () => {},
...
const staticBodySections = {
  ...
  en: {
    ...
    contact:
      '\n      <div class="container is-max-desktop">\n        <p class="section-kicker">Contact</p>\n        <h2 class="title is-3">Project Join Inquiry</h2>\n        <div class="content">\n          <p>Please contact the author Insung Bae\'s Instagram @in_bae_nim_hcmv Direct Message for project participation or data visualization collaboration inquiries.</p>\n        </div>\n      </div>',
  },
};
...
function syncAnalysisNarrative() {
  ...
  const capitalChart = document.querySelector(
    '[data-comparison-chart][data-comparison-type="capital"]',
  );
  const reasonBox = capitalChart?.nextElementSibling?.nextElementSibling;
  if (reasonBox?.matches(".reason-box")) {
    const capitalParagraph = syncParagraphAfter(
      reasonBox,
      "[data-capital-access-analysis]",
      copy.capitalAccess,
      (element) => {
    ...
    if (
      staleCapitalPlaceholder?.tagName === "P" &&
      /^\((향후 추가 예정|To be added)\)$/.test(
        staleCapitalPlaceholder.textContent.trim(),
      )
    ) {
  ...
  const localChart = document.querySelector(
    '[data-comparison-chart][data-comparison-type="local"]',
  );
  ...
  if (conclusionTitle) {
    conclusionTitle.parentElement
      .querySelectorAll("[data-synced-conclusion]")
...
function syncNotesSection() {
  ...
  const referenceHeading = Array.from(content.querySelectorAll("h3")).find(
    (heading) =>
      /^(참고 데이터 및 사이트|Reference Data and Sites)$/.test(
  ...
  copy.sources.forEach((source) => {
    const exists = Array.from(
      content.querySelectorAll(`a[href="${source.href}"]`),
    ).some(Boolean);
    if (exists) return;
    ...
    while (
      ...
      insertionPoint.nextElementSibling.tagName === "P"
    ) {
...
const chartText = {
  ko: {
    ...
    seoulAverageNote:
      "서울 전체 1년 평균 거래가격입니다. 구를 선택하면 지도와 월별 추세가 함께 강조됩니다.",
  },
  en: {
    ...
    seoulAverageNote:
      "Seoul's one-year average transaction price. Select a district to highlight the map and monthly trend.",
  },
};
...
const koreaRegionLegend = [
  ...
  {
    color: "#c77b9a",
    label: { ko: "대구·경북권", en: "Daegu-Gyeongbuk Region" },
  },
];
...
const seoulRegionLegend = [
  {
    color: "#b65f5b",
    label: { ko: "서울 평균 (14.0억 원)", en: "Seoul Average (₩1.40B)" },
  },
  {
    color: "#5f83ad",
    label: { ko: "서울 평균보다 높음", en: "Above Seoul Average" },
  },
  {
    color: "#6f9b78",
    label: { ko: "서울 평균보다 낮음", en: "Below Seoul Average" },
  },
];
...
const graphData = [
  {
    ...
    name: { ko: "서울 전체", en: "All Seoul" },
    value: 14.04,
    trend: [
      12.85, 12.98, 13.37, 13.61, 13.77, 13.9, 14.16, 14.44, 14.62, 14.76,
      14.93, 15.1,
    ],
  },
  {
    id: "gangnam",
    color: "#5f83ad",
    cluster: { ko: "상급지", en: "Upper Tier" },
    name: { ko: "강남구", en: "Gangnam-gu" },
    value: 30.28,
    trend: [
      27.06, 27.68, 29.27, 29.75, 30.13, 30.39, 30.73, 31.15, 31.58, 31.85,
      31.95, 31.8,
    ],
  },
  {
    ...
    color: "#5f83ad",
    cluster: { ko: "상급지", en: "Upper Tier" },
    name: { ko: "강동구", en: "Gangdong-gu" },
    value: 14.11,
    trend: [
      12.61, 12.65, 12.95, 13.35, 13.53, 13.74, 14.54, 14.86, 14.97, 15.14,
      15.32, 15.69,
    ],
  },
  {
    id: "gangbuk",
    color: "#6f9b78",
    cluster: { ko: "하급지", en: "Lower Tier" },
    name: { ko: "강북구", en: "Gangbuk-gu" },
    value: 6.94,
    trend: [
      6.84, 6.84, 6.83, 6.88, 6.88, 6.9, 6.9, 6.93, 6.97, 7.0, 7.08, 7.23,
    ],
  },
  {
    id: "gangseo",
    color: "#6f9b78",
    cluster: { ko: "하급지", en: "Lower Tier" },
    name: { ko: "강서구", en: "Gangseo-gu" },
    value: 9.96,
    trend: [
      9.56, 9.59, 9.63, 9.69, 9.74, 9.81, 9.89, 10.06, 10.16, 10.24, 10.46,
      10.7,
    ],
  },
  {
    ...
    color: "#6f9b78",
    cluster: { ko: "하급지", en: "Lower Tier" },
    name: { ko: "관악구", en: "Gwanak-gu" },
    value: 8.55,
    trend: [
      8.1, 8.2, 8.26, 8.3, 8.33, 8.37, 8.47, 8.61, 8.71, 8.86, 9.11, 9.33,
    ],
  },
  {
    id: "gwangjin",
    color: "#5f83ad",
    cluster: { ko: "상급지", en: "Upper Tier" },
    name: { ko: "광진구", en: "Gwangjin-gu" },
    value: 15.72,
    trend: [
      13.82, 13.95, 14.25, 14.67, 14.89, 15.15, 16.14, 16.83, 17.03, 17.15,
      17.32, 17.49,
    ],
  },
  {
    ...
    color: "#6f9b78",
    cluster: { ko: "하급지", en: "Lower Tier" },
    name: { ko: "구로구", en: "Guro-gu" },
    value: 7.91,
    trend: [
      7.69, 7.69, 7.71, 7.77, 7.81, 7.85, 7.89, 7.95, 8.0, 8.05, 8.18, 8.34,
    ],
  },
  {
    id: "geumcheon",
    color: "#6f9b78",
    cluster: { ko: "하급지", en: "Lower Tier" },
    name: { ko: "금천구", en: "Geumcheon-gu" },
    value: 7.33,
    trend: [
      7.3, 7.3, 7.28, 7.31, 7.33, 7.34, 7.34, 7.33, 7.34, 7.35, 7.36, 7.39,
    ],
  },
  {
    id: "nowon",
    color: "#6f9b78",
    cluster: { ko: "하급지", en: "Lower Tier" },
    name: { ko: "노원구", en: "Nowon-gu" },
    value: 7.67,
    trend: [
      7.53, 7.57, 7.57, 7.59, 7.61, 7.63, 7.65, 7.7, 7.72, 7.76, 7.82, 7.93,
    ],
  },
  {
    id: "dobong",
    color: "#6f9b78",
    cluster: { ko: "하급지", en: "Lower Tier" },
    name: { ko: "도봉구", en: "Dobong-gu" },
    value: 6.29,
    trend: [
      6.23, 6.23, 6.24, 6.25, 6.26, 6.27, 6.29, 6.3, 6.32, 6.33, 6.37, 6.42,
    ],
  },
  {
    id: "dongdaemun",
    color: "#6f9b78",
    cluster: { ko: "하급지", en: "Lower Tier" },
    name: { ko: "동대문구", en: "Dongdaemun-gu" },
    value: 10.31,
    trend: [
      9.42, 9.43, 9.47, 9.56, 10.17, 10.23, 10.39, 10.68, 10.84, 10.95, 11.1,
      11.46,
    ],
  },
  {
    ...
    color: "#6f9b78",
    cluster: { ko: "하급지", en: "Lower Tier" },
    name: { ko: "동작구", en: "Dongjak-gu" },
    value: 13.9,
    trend: [
      12.49, 12.6, 12.88, 13.12, 13.33, 13.5, 13.83, 14.46, 14.63, 15.07, 15.25,
      15.6,
    ],
  },
  {
    ...
    color: "#5f83ad",
    cluster: { ko: "상급지", en: "Upper Tier" },
    name: { ko: "마포구", en: "Mapo-gu" },
    value: 15.72,
    trend: [
      14.27, 14.38, 14.61, 15.02, 15.19, 15.38, 15.86, 16.38, 16.53, 16.68,
      17.02, 17.28,
    ],
  },
  {
    ...
    color: "#6f9b78",
    cluster: { ko: "하급지", en: "Lower Tier" },
    name: { ko: "서대문구", en: "Seodaemun-gu" },
    value: 10.81,
    trend: [
      10.12, 10.13, 10.3, 10.47, 10.57, 10.63, 10.78, 11.0, 11.1, 11.25, 11.53,
      11.79,
    ],
  },
  {
    ...
    color: "#5f83ad",
    cluster: { ko: "상급지", en: "Upper Tier" },
    name: { ko: "서초구", en: "Seocho-gu" },
    value: 30.35,
    trend: [
      27.31, 27.94, 29.2, 29.7, 30.09, 30.36, 30.61, 30.95, 31.61, 31.94, 32.21,
      32.23,
    ],
  },
  {
    ...
    color: "#5f83ad",
    cluster: { ko: "상급지", en: "Upper Tier" },
    name: { ko: "성동구", en: "Seongdong-gu" },
    value: 16.65,
    trend: [
      14.75, 14.93, 15.41, 15.89, 16.05, 16.21, 16.83, 17.52, 17.71, 17.87,
      18.12, 18.56,
    ],
  },
  {
    ...
    color: "#6f9b78",
    cluster: { ko: "하급지", en: "Lower Tier" },
    name: { ko: "성북구", en: "Seongbuk-gu" },
    value: 9.04,
    trend: [8.74, 8.76, 8.8, 8.85, 8.86, 8.91, 8.97, 9.1, 9.16, 9.27, 9.4, 9.7],
  },
  {
    id: "songpa",
    color: "#5f83ad",
    cluster: { ko: "상급지", en: "Upper Tier" },
    name: { ko: "송파구", en: "Songpa-gu" },
    value: 23.25,
    trend: [
      20.66, 20.9, 21.73, 22.32, 22.88, 23.21, 23.73, 24.13, 24.64, 24.8, 25.06,
      24.9,
    ],
  },
  {
    ...
    color: "#6f9b78",
    cluster: { ko: "하급지", en: "Lower Tier" },
    name: { ko: "양천구", en: "Yangcheon-gu" },
    value: 14.03,
    trend: [
      12.53, 12.78, 13.31, 13.77, 13.83, 13.95, 14.22, 14.57, 14.7, 14.79,
      14.89, 15.06,
    ],
  },
  {
    ...
    color: "#6f9b78",
    cluster: { ko: "하급지", en: "Lower Tier" },
    name: { ko: "영등포구", en: "Yeongdeungpo-gu" },
    value: 12.39,
    trend: [
      11.43, 11.52, 11.7, 11.91, 12.0, 12.13, 12.42, 12.69, 12.89, 13.02, 13.29,
      13.72,
    ],
  },
  {
    ...
    color: "#5f83ad",
    cluster: { ko: "상급지", en: "Upper Tier" },
    name: { ko: "용산구", en: "Yongsan-gu" },
    value: 18.23,
    trend: [
      16.77, 16.86, 17.13, 17.43, 17.71, 17.95, 18.27, 18.63, 19.12, 19.36,
      19.54, 19.99,
    ],
  },
  {
    ...
    color: "#6f9b78",
    cluster: { ko: "하급지", en: "Lower Tier" },
    name: { ko: "은평구", en: "Eunpyeong-gu" },
    value: 8.77,
    trend: [
      8.59, 8.6, 8.62, 8.66, 8.67, 8.68, 8.71, 8.76, 8.81, 8.87, 9.03, 9.26,
    ],
  },
  {
    id: "jongno",
    color: "#6f9b78",
    cluster: { ko: "하급지", en: "Lower Tier" },
    name: { ko: "종로구", en: "Jongno-gu" },
    value: 13.75,
    trend: [
      13.12, 13.24, 13.43, 13.59, 13.63, 13.69, 13.72, 13.95, 14.02, 14.04,
      14.18, 14.41,
    ],
  },
  {
    ...
    color: "#6f9b78",
    cluster: { ko: "하급지", en: "Lower Tier" },
    name: { ko: "중구", en: "Jung-gu" },
    value: 13.18,
    trend: [
      12.13, 12.16, 12.33, 12.57, 12.65, 12.85, 13.07, 13.6, 14.03, 14.12,
      14.24, 14.44,
    ],
  },
  {
    ...
    color: "#6f9b78",
    cluster: { ko: "하급지", en: "Lower Tier" },
    name: { ko: "중랑구", en: "Jungnang-gu" },
    value: 7.34,
    trend: [
      7.25, 7.27, 7.28, 7.29, 7.3, 7.32, 7.32, 7.35, 7.36, 7.4, 7.44, 7.54,
    ],
  },
];
...
const koreaMapData = [
  {
    ...
    price: 14.04,
    note: {
      ko: "2025.04-2026.03 KB부동산 자료 기준 1년 평균 거래가격입니다.",
      en: "One-year average transaction price based on KB Real Estate data, Apr. 2025 to Mar. 2026.",
    },
  },
  {
    id: "busan",
...
koreaMapData.push(
  {
    id: "capitalArea",
    color: "#b65f5b",
    cluster: { ko: "권역 평균", en: "Regional Average" },
    name: { ko: "수도권 평균", en: "Capital Area Average" },
    price: 8.09,
    note: {
      ko: "2025.04-2026.03 KB부동산 자료 기준 1년 평균 거래가격입니다.",
      en: "One-year average transaction price based on KB Real Estate data, Apr. 2025 to Mar. 2026.",
  ...
  },
  {
    ...
    color: "#c48755",
    cluster: { ko: "권역 평균", en: "Regional Average" },
    name: { ko: "강원/제주권 평균", en: "Gangwon/Jeju Average" },
    price: 3.78,
    note: {
      ko: "2025.04-2026.03 KB부동산 자료 기준 1년 평균 거래가격입니다.",
      en: "One-year average transaction price based on KB Real Estate data, Apr. 2025 to Mar. 2026.",
  ...
  },
  {
    ...
    color: "#6f9b78",
    cluster: { ko: "권역 평균", en: "Regional Average" },
    name: { ko: "충청권 평균", en: "Chungcheong Average" },
    price: 3.73,
    note: {
      ko: "2025.04-2026.03 KB부동산 자료 기준 1년 평균 거래가격입니다.",
      en: "One-year average transaction price based on KB Real Estate data, Apr. 2025 to Mar. 2026.",
  ...
  },
  {
    ...
    color: "#5f83ad",
    cluster: { ko: "권역 평균", en: "Regional Average" },
    name: { ko: "호남권 평균", en: "Honam Average" },
    price: 2.75,
    note: {
      ko: "2025.04-2026.03 KB부동산 자료 기준 1년 평균 거래가격입니다.",
      en: "One-year average transaction price based on KB Real Estate data, Apr. 2025 to Mar. 2026.",
  ...
  },
  {
    ...
    color: "#8b6f5a",
    cluster: { ko: "권역 평균", en: "Regional Average" },
    name: { ko: "동남권 평균", en: "Southeast Average" },
    price: 3.48,
    note: {
      ko: "2025.04-2026.03 KB부동산 자료 기준 1년 평균 거래가격입니다.",
      en: "One-year average transaction price based on KB Real Estate data, Apr. 2025 to Mar. 2026.",
  ...
  },
  {
    ...
    color: "#c77b9a",
    cluster: { ko: "권역 평균", en: "Regional Average" },
    name: { ko: "대구/경북권 평균", en: "Daegu/Gyeongbuk Average" },
    price: 2.98,
    note: {
      ko: "2025.04-2026.03 KB부동산 자료 기준 1년 평균 거래가격입니다.",
      en: "One-year average transaction price based on KB Real Estate data, Apr. 2025 to Mar. 2026.",
...
const seoulMapData = [
  {
    id: "seoul",
    cluster: { ko: "서울 전체", en: "Seoul Average" },
    name: { ko: "서울 평균", en: "Seoul Average" },
    price: 14.04,
    note: {
      ko: "2025.04-2026.03 KB부동산 자료 기준 서울시 전체 및 행정구역별 1년 평균 거래가격입니다.",
      en: "One-year average transaction price for all Seoul and each administrative district based on KB Real Estate data, Apr. 2025 to Mar. 2026.",
    },
  },
  {
    id: "gangnam",
    cluster: { ko: "강남권", en: "Southeast Seoul" },
    name: { ko: "강남구", en: "Gangnam-gu" },
    price: 30.28,
    note: {
      ko: "2025.04-2026.03 KB부동산 자료 기준 서울시 전체 및 행정구역별 1년 평균 거래가격입니다.",
  ...
  {
    id: "gangdong",
    cluster: { ko: "강동권", en: "Eastern Seoul" },
    name: { ko: "강동구", en: "Gangdong-gu" },
    price: 14.11,
    note: {
      ko: "2025.04-2026.03 KB부동산 자료 기준 서울시 전체 및 행정구역별 1년 평균 거래가격입니다.",
  ...
  {
    id: "gangbuk",
    cluster: { ko: "강북권", en: "Northern Seoul" },
    name: { ko: "강북구", en: "Gangbuk-gu" },
    price: 6.94,
    note: {
      ko: "2025.04-2026.03 KB부동산 자료 기준 서울시 전체 및 행정구역별 1년 평균 거래가격입니다.",
  ...
  {
    id: "gangseo",
    cluster: { ko: "서남권", en: "Western Seoul" },
    name: { ko: "강서구", en: "Gangseo-gu" },
    price: 9.96,
    note: {
      ko: "2025.04-2026.03 KB부동산 자료 기준 서울시 전체 및 행정구역별 1년 평균 거래가격입니다.",
  ...
  {
    id: "gwanak",
    cluster: { ko: "서남권", en: "Southwest Seoul" },
    name: { ko: "관악구", en: "Gwanak-gu" },
    price: 8.55,
    note: {
      ko: "2025.04-2026.03 KB부동산 자료 기준 서울시 전체 및 행정구역별 1년 평균 거래가격입니다.",
  ...
  {
    id: "gwangjin",
    cluster: { ko: "동북권", en: "Northeast Seoul" },
    name: { ko: "광진구", en: "Gwangjin-gu" },
    price: 15.72,
    note: {
      ko: "2025.04-2026.03 KB부동산 자료 기준 서울시 전체 및 행정구역별 1년 평균 거래가격입니다.",
  ...
  {
    id: "mapo",
    cluster: { ko: "서북권", en: "Northwest Seoul" },
    name: { ko: "마포구", en: "Mapo-gu" },
    price: 15.72,
    note: {
      ko: "2025.04-2026.03 KB부동산 자료 기준 서울시 전체 및 행정구역별 1년 평균 거래가격입니다.",
  ...
  {
    id: "seongdong",
    cluster: { ko: "도심권", en: "Central Seoul" },
    name: { ko: "성동구", en: "Seongdong-gu" },
    price: 16.65,
    note: {
      ko: "2025.04-2026.03 KB부동산 자료 기준 서울시 전체 및 행정구역별 1년 평균 거래가격입니다.",
...
function updateStage() {
  ...
  const activeIndex = Math.min(
    panels.length - 1,
    Math.floor(rawProgress * panels.length),
  );
  ...
  document.documentElement.style.setProperty(
    "--hero-scale",
    (1 + rawProgress * 0.38).toFixed(3),
  );
  document.documentElement.style.setProperty(
    "--hero-shift",
    `${Math.round(rawProgress * -90)}px`,
  );
}
...
function getTrendSummary(trend, lang) {
  ...
  if (jumpAmount >= 0.7 && jumpIndex > 0) {
    ...
    return lang === "ko"
      ? `${from}에서 ${to} 사이에 가파른 상승세를 보였습니다.`
      : `${labels.trendJump} ${from} and ${to}.`;
  }
...
function drawSparkline(container, trend) {
  ...
  const circles = points
    .map(
      ([x, y]) =>
        `<circle cx="${x.toFixed(1)}" cy="${y.toFixed(1)}" r="3"></circle>`,
    )
    .join("");
...
function formatCount(value, lang) {
  return lang === "ko"
    ...
    : `${Math.round(value).toLocaleString("en-US")} academies`;
}
...
function updateInteractiveChart(chart, selectedId) {
  ...
  chart.querySelectorAll(".chart-choice").forEach((button) => {
    ...
    button.setAttribute(
      "aria-pressed",
      String(button.dataset.region === selected.id),
    );
  });

  chart.querySelector("[data-detail-cluster]").textContent =
    selected.cluster[lang];
  chart.querySelector("[data-detail-name]").textContent = selected.name[lang];
  chart.querySelector("[data-detail-value]").textContent = formatPrice(
    selected.value,
    lang,
  );
  chart.querySelector("[data-detail-note]").textContent =
    `${labels.average}: ${formatPrice(selected.value, lang)} | ${labels.rank}: ${rank}/${graphData.length}. ${getTrendSummary(selected.trend, lang)}`;
...
const comparisonChartData = {
  capital: {
    label: {
      ko: "Price Comparison Visualization",
      en: "Price Comparison Visualization",
    },
    title: {
      ko: "수도권 주요 지역 대비 지방 전체 거래 평균가 간 비교",
      en: "Comparison Between Major Capital-Area Regions and the Overall Local Average",
    },
    description: {
      ko: "행정구역별 버튼을 선택하면 해당 구역의 최근 12개월 간 아파트 평균 거래가격을 확인할 수 있습니다.",
      en: "Select an administrative-region button to view the recent 12-month average apartment transaction price.",
    },
    baseline: { ko: "지방 평균", en: "Local Average" },
    baselineValue: 3.06,
    footnote: {
      ko: "* 화성시 동탄구의 경우, 화성시의 행정구역 개편이 2026년 02월에 이루어진 관계로 KB부동산 시세 데이터가 2026년 02월과 03월 총 2달간의 데이터만 집계되어 있음. 데이터의 부정확성에 대해 일부 감안 필요.",
      en: "* For Hwaseong Dongtan-gu, KB Real Estate price data is available only for February and March 2026 because Hwaseong's administrative-district reorganization took place in February 2026. Some caution is needed regarding data accuracy.",
    },
    items: [
      {
        id: "incheonYeonsu",
        name: { ko: "인천 연수", en: "Incheon Yeonsu" },
        value: 5.71,
      },
      {
        id: "incheonSeo",
        name: { ko: "인천 서", en: "Incheon Seo" },
        value: 4.86,
      },
      {
        id: "goyangIlsandong",
        name: { ko: "고양 일산동", en: "Goyang Ilsandong" },
        value: 5.75,
      },
      {
        id: "goyangIlsanseo",
        name: { ko: "고양 일산서", en: "Goyang Ilsanseo" },
        value: 4.37,
      },
      ...
      {
        id: "bucheonWonmi",
        name: { ko: "부천 원미", en: "Bucheon Wonmi" },
        value: 6.46,
      },
      {
        id: "bundang",
        name: { ko: "성남 분당", en: "Seongnam Bundang" },
        value: 14.56,
      },
      {
        id: "suwonYeongtong",
        name: { ko: "수원 영통", en: "Suwon Yeongtong" },
        value: 7.78,
      },
      {
        id: "anyangDongan",
        name: { ko: "안양 동안", en: "Anyang Dongan" },
        value: 8.32,
      },
      {
        id: "yonginSuji",
        name: { ko: "용인 수지", en: "Yongin Suji" },
        value: 8.78,
      },
      {
        id: "hwaseongDongtan",
        name: { ko: "화성 동탄", en: "Hwaseong Dongtan" },
        value: 7.54,
      },
    ],
  },
  local: {
    ...
    title: {
      ko: "지방 주요 지역 대비 지방 전체 평균가 간 비교",
      en: "Comparison Between Major Local Regions and the Overall Local Average",
    },
    description: {
      ko: "행정구역별 버튼을 선택하면 해당 구역의 최근 12개월 간 아파트 평균 거래가격을 확인할 수 있습니다.",
      en: "Select an administrative-region button to view the recent 12-month average apartment transaction price.",
    ...
    items: [
      {
        id: "daeguSuseong",
        name: { ko: "대구 수성", en: "Daegu Suseong" },
        value: 5.3,
      },
      {
        id: "daejeonYuseong",
        name: { ko: "대전 유성", en: "Daejeon Yuseong" },
        value: 4.56,
      },
      {
        id: "daejeonSeo",
        name: { ko: "대전 서", en: "Daejeon Seo" },
        value: 3.91,
      },
      { id: "ulsanNam", name: { ko: "울산 남", en: "Ulsan Nam" }, value: 4.39 },
      { id: "sejongMajor", name: { ko: "세종", en: "Sejong" }, value: 5.52 },
      {
        id: "cheongjuHeungdeok",
        name: { ko: "청주 흥덕", en: "Cheongju Heungdeok" },
        value: 3.77,
      },
      {
        id: "changwonSeongsan",
        name: { ko: "창원 성산", en: "Changwon Seongsan" },
        value: 4.12,
      },
      {
        id: "changwonUichang",
        name: { ko: "창원 의창", en: "Changwon Uichang" },
        value: 3.73,
      },
      {
        id: "busanHaeundae",
        name: { ko: "부산 해운대", en: "Busan Haeundae" },
        value: 5.57,
      },
    ],
  },
  academy: {
    ...
    title: {
      ko: "지방 학군지의 학원 갯수 지표",
      en: "Academy Count Indicator for Local School-District Areas",
    },
    description: {
      ko: "행정구역별 버튼을 선택하면 2026년 03월 기준 해당 구역의 학원 갯수를 확인할 수 있습니다.",
      en: "Select an administrative-region button to view the academy count as of March 2026.",
    },
    detailLabel: { ko: "학원 갯수", en: "Academy Count" },
    baseline: {
      ko: "지방 기초자치단체 평균",
      en: "Local Municipality Average",
    },
    baselineValue: 366.7,
    valueType: "count",
    footnote: {
      ko: "* 학원 갯수는 2026년 03월의 지표를 기반으로 함. 평균값은 서울/경기/인천교육청 관할 구역을 제외한 지방 기초자치단체 기준.",
      en: "* Academy counts are based on the March 2026 indicator. The average excludes districts under the Seoul, Gyeonggi, and Incheon education offices.",
    },
    items: [
      {
        id: "daeguSuseongAcademy",
        name: { ko: "대구 수성", en: "Daegu Suseong" },
        value: 2489,
      },
      {
        id: "daejeonYuseongAcademy",
        name: { ko: "대전 유성", en: "Daejeon Yuseong" },
        value: 1156,
      },
      {
        id: "daejeonSeoAcademy",
        name: { ko: "대전 서", en: "Daejeon Seo" },
        value: 1473,
      },
      {
        id: "ulsanNamAcademy",
        name: { ko: "울산 남", en: "Ulsan Nam" },
        value: 1364,
      },
      {
        id: "busanHaeundaeAcademy",
        name: { ko: "부산 해운대", en: "Busan Haeundae" },
        value: 1407,
      },
    ],
...
const transactionVolumeData = {
  ...
  title: {
    ko: "정권별 주택매매거래량 비교",
    en: "Housing Transaction Volume by Administration",
  },
  description: {
    ko: "",
    en: "",
  ...
  series: [
    {
      id: "capital",
      color: "#1f5eff",
      name: { ko: "수도권 거래량", en: "Capital Area Volume" },
      values: [
        44289, 43335, 35187, 30982, 33065, 34816, 43013, 54233, 43661, 37674,
        34301, 37502, 58242, 63712, 58963, 57227, 57105, 49892, 45932, 56199,
        49392, 43315, 29705, 28084, 38311, 43452, 49477, 52864, 56629, 56792,
        51868, 60728, 54976, 45376, 26042, 28459, 37836, 39467, 47093, 57251,
        58247, 57094, 46019, 31487, 37550, 37441, 37328, 40538, 54144, 37045,
        35054, 31521, 33509, 38604, 49219, 54823, 32921, 25986, 22483, 18390,
        22375, 25366, 26826, 26944, 34471, 35290, 33335, 42465, 48547, 62374,
        55382, 66456, 65051, 36852, 40228, 75534, 75725, 43107, 38089, 41884,
        41117, 63203, 47132, 47433, 49358, 45012, 47389, 42016, 42074, 41668,
        37225, 31982, 26365, 21573, 16209, 16149, 20109, 23346, 26314, 21704,
        16734, 13883, 12609, 12102, 11428, 11127, 10299, 17240, 22722, 20830,
        24739, 23989, 22179, 23277, 22741, 19791, 18010, 15083, 17608, 18916,
        22722, 27124, 27603, 28703, 37684, 32776, 25829, 25011, 21777, 20235,
        17846, 24026, 35556, 33820, 32362, 42967, 34704, 21673, 31298, 39644,
        27697, 29048, 30142, 29459, 36008,
      ],
    },
    {
      id: "local",
      color: "#6f9b78",
      name: { ko: "지방 거래량", en: "Local Volume" },
      values: [
        45637, 49873, 43023, 42553, 44221, 41569, 43676, 55142, 47389, 53456,
        45019, 41362, 53627, 56776, 50909, 53156, 53570, 44218, 40220, 50075,
        48421, 44556, 32660, 31181, 39542, 42846, 39790, 39747, 38949, 41338,
        39744, 47873, 47912, 43225, 32497, 35025, 39474, 35914, 37953, 40747,
        40167, 39484, 38331, 31723, 37598, 34205, 33026, 29141, 38651, 34706,
        32735, 33506, 30178, 27341, 26922, 37743, 31883, 29695, 27803, 25054,
        28982, 31659, 30277, 27949, 32878, 31216, 30753, 39928, 43866, 56041,
        45952, 48808, 43626, 36679, 43266, 63044, 65694, 42165, 43839, 50885,
        75641, 77078, 43547, 39588, 52751, 48056, 50135, 46906, 46863, 47389,
        44406, 43308, 40794, 32201, 25500, 27030, 33352, 35061, 36886, 28600,
        22866, 21648, 19794, 20071, 18792, 17476, 15462, 23951, 29611, 26725,
        30437, 28603, 25991, 28301, 26707, 28008, 27405, 22953, 25425, 24575,
        30094, 31091, 29833, 27057, 30612, 27872, 25438, 31568, 27337, 25686,
        20476, 26672, 31703, 31601, 30341, 30871, 29531, 24579, 32067, 30074,
        33710, 33845, 31308, 28326, 35967,
      ],
    },
  ],
  periods: [
    {
      id: "all",
      name: { ko: "전체 기간", en: "Full Period" },
      range: "2014.03-2026.03",
      start: "2014.03",
      end: "2026.03",
    },
    {
      id: "park",
      name: { ko: "박근혜 정부", en: "Park Geun-hye" },
      range: "2014.03-2017.05",
      start: "2014.03",
      end: "2017.05",
    },
    {
      id: "moon",
      name: { ko: "문재인 정부", en: "Moon Jae-in" },
      range: "2017.05-2022.05",
      start: "2017.05",
      end: "2022.05",
    },
    {
      id: "yoon",
      name: { ko: "윤석열 정부", en: "Yoon Suk Yeol" },
      range: "2022.05-2025.06",
      start: "2022.05",
      end: "2025.06",
    },
    {
      id: "lee",
      name: { ko: "이재명 정부", en: "Lee Jae-myung" },
  ...
  policies: [
    {
      government: "park",
      date: "2014-09-01",
      name: { ko: "9.1 부동산 대책", en: "Sep. 1 Real Estate Measures" },
      direction: { ko: "완화", en: "Easing" },
    },
    {
      government: "park",
      date: "2016-08-25",
      name: { ko: "8.25 가계부채 대책", en: "Aug. 25 Household Debt Measures" },
      direction: { ko: "강화", en: "Tightening" },
    },
    {
      government: "park",
      date: "2016-11-03",
      name: { ko: "11.3 부동산 대책", en: "Nov. 3 Real Estate Measures" },
      direction: { ko: "강화", en: "Tightening" },
    },
    {
      government: "moon",
      date: "2017-06-19",
      name: { ko: "6.19 부동산 대책", en: "Jun. 19 Real Estate Measures" },
      direction: { ko: "강화", en: "Tightening" },
    },
    {
      government: "moon",
      date: "2017-08-02",
      name: { ko: "8.2 부동산 대책", en: "Aug. 2 Real Estate Measures" },
      direction: { ko: "강화", en: "Tightening" },
    },
    {
      government: "moon",
      date: "2017-09-05",
      name: { ko: "9.5 부동산 대책", en: "Sep. 5 Real Estate Measures" },
      direction: { ko: "강화", en: "Tightening" },
    },
    {
      government: "moon",
      ...
      name: {
        ko: "10.24 가계부채 대책",
        en: "Oct. 24 Household Debt Measures",
      },
      direction: { ko: "강화", en: "Tightening" },
    },
    {
      government: "moon",
      date: "2018-09-13",
      name: { ko: "9.13 부동산 대책", en: "Sep. 13 Real Estate Measures" },
      direction: { ko: "강화", en: "Tightening" },
    },
    {
      government: "moon",
      date: "2019-12-16",
      name: { ko: "12.16 부동산 대책", en: "Dec. 16 Real Estate Measures" },
      direction: { ko: "강화", en: "Tightening" },
    },
    {
      government: "moon",
      date: "2020-06-17",
      name: { ko: "6.17 부동산 대책", en: "Jun. 17 Real Estate Measures" },
      direction: { ko: "강화", en: "Tightening" },
    },
    {
      government: "moon",
      date: "2020-07-10",
      name: { ko: "7.10 부동산 대책", en: "Jul. 10 Real Estate Measures" },
      direction: { ko: "강화", en: "Tightening" },
    },
    {
      government: "moon",
      date: "2020-08-04",
      name: { ko: "8.4 부동산 대책", en: "Aug. 4 Real Estate Measures" },
      direction: { ko: "중립", en: "Neutral" },
    },
    {
      government: "moon",
      date: "2021-02-04",
      name: { ko: "2.4 부동산 대책", en: "Feb. 4 Real Estate Measures" },
      direction: { ko: "중립", en: "Neutral" },
    },
    {
      government: "yoon",
      date: "2023-01-03",
      name: { ko: "1.3 부동산 대책", en: "Jan. 3 Real Estate Measures" },
      direction: { ko: "완화", en: "Easing" },
    },
    {
      government: "yoon",
      date: "2024-01-10",
      name: { ko: "1.10 부동산 대책", en: "Jan. 10 Real Estate Measures" },
      direction: { ko: "완화/지원", en: "Easing/Support" },
    },
    {
      government: "yoon",
      date: "2024-08-08",
      name: { ko: "8.8 부동산 대책", en: "Aug. 8 Real Estate Measures" },
      direction: { ko: "지원", en: "Support" },
    },
    {
      government: "lee",
      date: "2025-06-27",
      name: { ko: "6.27 부동산 대책", en: "Jun. 27 Real Estate Measures" },
      direction: { ko: "강화", en: "Tightening" },
    },
    {
      government: "lee",
    ...
    },
    {
      government: "lee",
      date: "2025-10-15",
      name: { ko: "10.15 부동산 대책", en: "Oct. 15 Real Estate Measures" },
      direction: { ko: "강화", en: "Tightening" },
    },
  ],
};
...
const areaPriceData = {
  ...
  title: {
    ko: "중소형 평형 매매평균가 비교",
    en: "Average Sale Price for Mid-Small Unit Sizes",
  },
  description: {
    ko: "",
    en: "",
  ...
  lineTitle: {
    ko: "중소형 평형 매매평균가",
    en: "Mid-Small Unit Average Sale Price",
  },
  footnote: {
  ...
  series: [
    {
      id: "seoul",
      color: "#b65f5b",
      name: { ko: "서울 중소형 평균", en: "Seoul Mid-Small Average" },
      values: [
        49283.0, 49354.9, 49417.0, 49560.5, 49865.0, 50237.1, 50750.8, 51326.5,
        51772.0, 52628.3, 53325.5, 53499.5, 53575.1, 53665.2, 53810.8, 53975.5,
        54464.0, 55332.1, 56013.3, 57171.4, 57501.7, 58118.0, 58953.0, 59884.8,
        61193.5, 62408.6, 64397.4, 65630.0, 66229.9, 66672.8, 67284.1, 68461.2,
        71895.6, 73677.2, 74513.6, 74771.3, 69607.4, 69581.6, 69445.3, 69421.8,
        69501.4, 69651.1, 70506.9, 71166.3, 71824.0, 72276.9, 73048.6, 74292.0,
        76668.8, 77680.1, 79157.7, 79567.4, 79654.5, 80663.8, 83136.6, 85489.5,
        87835.2, 88986.4, 90728.7, 92151.2, 93921.1, 95947.2, 97629.4, 98658.5,
        99585.5, 101262.4, 102464.1, 104201.2, 106002.7, 109963.7, 114308.7,
        116224.8, 118193.8, 120180.5, 121798.2, 122895.0, 123545.7, 123652.6,
        123678.8, 123273.2, 122221.6, 120844.1, 123760.5, 121663.5, 118953.8,
        117426.1, 115784.1, 114714.5, 113863.2, 113842.4, 113860.0, 114316.9,
        115058.5, 115550.7, 115772.1, 115622.9, 115419.1, 115300.6, 115229.2,
        115243.6, 115423.6, 115874.3, 117134.5, 118882.4, 120339.7, 121258.1,
        122477.1, 123087.3, 123292.4, 123704.3, 125518.7, 128525.1, 129859.1,
        133715.8, 136151.9, 137730.8, 139027.0, 141637.3, 144416.2, 146278.8,
        147650.0, 149322.7, 151021.7, 151860.7, 152698.7,
      ],
    },
    {
      id: "capital",
      color: "#1f5eff",
      name: { ko: "수도권 중소형 평균", en: "Capital Area Mid-Small Average" },
      values: [
        35838.9, 35889.6, 35927.7, 35998.4, 36144.8, 36319.0, 36556.1, 36825.0,
        37045.5, 37462.4, 37830.1, 37940.4, 37990.3, 38034.6, 38116.1, 38190.6,
        38393.5, 38758.1, 39068.5, 39578.2, 39769.7, 40024.7, 40371.4, 40732.6,
        41283.3, 41795.1, 42589.7, 43093.2, 43350.2, 43535.6, 43782.0, 44248.8,
        45778.9, 46633.8, 47002.3, 47122.8, 44135.7, 44127.2, 44075.5, 44022.0,
        44001.7, 44036.7, 44291.1, 44512.4, 44734.8, 45103.6, 45490.7, 46260.1,
        46854.4, 47530.8, 48655.4, 49027.2, 49201.5, 49886.6, 51230.9, 52382.9,
        53565.7, 54235.4, 55341.1, 56382.4, 57641.6, 59319.3, 60865.4, 61999.7,
        62906.4, 64340.5, 65491.0, 67101.0, 68678.2, 71031.4, 73641.3, 74803.7,
        75989.7, 77184.2, 78140.0, 78772.6, 79125.0, 79177.7, 79170.0, 78728.8,
        77830.0, 76614.9, 77090.6, 75408.9, 73335.8, 72147.7, 70974.0, 70025.6,
        69488.7, 69409.3, 69391.5, 69715.6, 70144.3, 70479.2, 70692.3, 70658.2,
        70587.5, 70523.1, 70465.6, 70436.0, 70440.8, 70611.3, 71014.9, 71698.2,
        72296.9, 72688.2, 73087.8, 73223.8, 73235.6, 73346.5, 73856.1, 74756.5,
        75148.4, 76315.2, 77062.4, 77605.1, 78025.9, 78922.1, 79925.5, 80638.3,
        81154.8, 81894.5, 82690.4, 83127.4, 83535.3,
      ],
    },
    {
      id: "local",
      color: "#6f9b78",
      name: { ko: "지방 중소형 평균", en: "Local Mid-Small Average" },
      values: [
        21101.5, 21131.9, 21163.8, 21181.9, 21201.1, 21196.8, 21213.4, 21236.6,
        21271.0, 21355.4, 21446.5, 21494.1, 21539.7, 21557.5, 21583.7, 21599.1,
        21613.7, 21652.1, 21695.6, 21739.2, 21750.9, 21758.1, 21779.8, 21789.9,
        21820.6, 21821.3, 21844.7, 21814.7, 21817.6, 21815.7, 21790.5, 21773.1,
        21786.5, 21809.9, 21775.6, 21782.8, 21586.7, 21550.1, 21511.7, 21456.3,
        21424.3, 21350.2, 21292.0, 21249.5, 21252.1, 21279.3, 21309.1, 21428.7,
        21577.1, 21808.7, 22106.2, 22184.0, 22226.7, 22542.3, 22902.2, 23272.4,
        23729.5, 24059.5, 24605.0, 25253.9, 25789.7, 26293.1, 26655.8, 26905.7,
        27145.3, 27461.8, 27734.4, 28122.0, 28459.9, 30002.3, 31524.1, 32203.5,
        32890.7, 33576.2, 34119.8, 34478.4, 34665.4, 34693.4, 34688.1, 34469.1,
        34060.6, 33638.7, 35538.7, 34927.7, 34183.2, 33745.4, 33404.9, 33108.0,
        32944.8, 32913.1, 32890.5, 32947.7, 33020.8, 33115.9, 33174.4, 33199.1,
        33249.4, 33235.8, 33225.6, 33174.5, 33145.5, 33120.1, 33108.6, 33219.7,
        33280.2, 33333.5, 33353.5, 33294.5, 33273.2, 33261.7, 33253.7, 33272.1,
        33329.0, 33422.0, 33546.4, 33598.3, 33646.9, 33673.7, 33752.6, 33900.4,
        34019.8, 34137.1, 34289.7, 34417.4, 34484.8,
      ],
    },
  ],
};
...
const grdpDonutData = {
  label: {
    ko: "GRDP Concentration Visualization",
    en: "GRDP Concentration Visualization",
  },
  title: {
    ko: "2024년 권역별 지역내총생산 비중",
    en: "Regional GRDP Share by Area, 2024",
  },
  description: {
  ...
  items: [
    {
      id: "capitalArea",
      color: "#b65f5b",
      name: { ko: "수도권", en: "Capital Area" },
      areas: { ko: "서울, 경기, 인천", en: "Seoul, Gyeonggi, Incheon" },
      value: 1352044,
    },
    {
      id: "southeast",
      color: "#8b6f5a",
      name: { ko: "동남권", en: "Southeast Region" },
      areas: { ko: "부산, 울산, 경남", en: "Busan, Ulsan, Gyeongnam" },
      value: 366264,
    },
    {
      id: "chungcheong",
      color: "#6f9b78",
      name: { ko: "충청권", en: "Chungcheong Region" },
      areas: {
        ko: "충북, 충남, 세종, 대전",
        en: "Chungbuk, Chungnam, Sejong, Daejeon",
      },
      value: 316135,
    },
    {
      id: "honam",
      color: "#5f83ad",
      name: { ko: "호남권", en: "Honam Region" },
      areas: { ko: "전북, 전남, 광주", en: "Jeonbuk, Jeonnam, Gwangju" },
      value: 224600,
    },
    {
      id: "daeguGyeongbuk",
      color: "#c77b9a",
      name: { ko: "대구·경북권", en: "Daegu-Gyeongbuk Region" },
      areas: { ko: "대구, 경북", en: "Daegu, Gyeongbuk" },
      value: 209222,
    },
    {
      id: "gangwonJeju",
      color: "#c48755",
      name: { ko: "강원·제주권", en: "Gangwon-Jeju Region" },
      areas: { ko: "강원, 제주", en: "Gangwon, Jeju" },
      value: 91544,
    },
  ],
  analysis: {
...
const seoulGrowthSectionCopy = {
  ko: {
    intro:
      "저희가 선정한 상급지와 하급지가 명확히 나뉘는 기준은 최근 1년간의 KB부동산 데이터 기반 서울시 실거래가 평균이 기준입니다. 이러한 기준에서 확인해보면, 강남구, 서초구, 송파구, 마포구, 용산구, 성동구, 강동구, 광진구가 상급지로 분류되며, 그 외 지역은 하급지로 분류됩니다. 해당 지역의 거래 시세를 조금 더 살펴보기 위해, 아래에서 각 지역별 최근 12개월 간 거래가 변동 추이 그래프를 보여드리고자 합니다.",
    afterTrend:
      "상급지와 하급지의 거래 금액에는 차이가 꽤 있는 편입니다. 다만, 근본적으로 왜 해당 지역이 상급지가 되었는가와 왜 해당 지역이 하급지가 되었는가에 대해서 따져보게 되면, 크게 짚어봐야 할 내용은 바로 서울특별시 2040 도시기본계획입니다.",
    planIntro:
      "도심/광역중심/지역중심 버튼을 선택하면 해당되는 기본계획 구역에 점의 형태로 강조표시가 생깁니다. 상급지 강조 스위치를 눌러 상급지 지역을 강조처리한 다음 각 버튼을 눌러가며 비교해보세요.",
  ...
  en: {
    intro:
      "The distinction between the upper-tier and lower-tier areas selected here is based on Seoul's average transaction prices from KB Real Estate data over the past year. Under this standard, Gangnam-gu, Seocho-gu, Songpa-gu, Mapo-gu, Yongsan-gu, Seongdong-gu, Gangdong-gu, and Gwangjin-gu are classified as upper-tier areas, while the other districts are classified as lower-tier areas. To examine transaction prices in these areas more closely, the graph below shows the recent 12-month transaction-price trend for each district.",
    afterTrend:
      "There is a fairly clear gap in transaction prices between upper-tier and lower-tier areas. However, if we ask why certain areas became upper-tier and why others became lower-tier, there are two major points that need to be examined. The first is Seoul's 2040 Comprehensive Urban Plan, which we will address here.",
    planIntro:
      "Select the metropolitan center, regional center, or local center buttons to mark the corresponding Seoul 2040 planning areas with dots. Turn on the upper-tier highlight switch, then compare the highlighted districts with each center layer.",
    cloneTitle:
      "Comparison Between the Seoul 2040 Comprehensive Urban Plan and Upper-Tier Areas",
    planAnalysis: [
      "The Seoul 2040 Comprehensive Urban Plan divides Seoul into 3 metropolitan centers, 7 regional centers, and 12 local centers in order to promote balanced development across the city. When the upper-tier highlight is turned on together with the 3 metropolitan centers and 7 regional centers, the areas identified as upper-tier districts can be seen near the metropolitan centers. Around the Gangnam metropolitan center, Gangnam, Seocho, Songpa, Gangdong, Yongsan, Seongdong, and Gwangjin are positioned nearby. Around the historic Seoul downtown center, Mapo, Yongsan, and Seongdong are adjacent, while around the Yeongdeungpo/Yeouido center, Mapo and Yongsan are nearby. This is also notable because four of the 7 regional centers are adjacent to upper-tier areas; in fact, Sangam/Susaek, Yongsan, and Jamsil among the 7 regional centers are located within those upper-tier areas. Looking further into the 12 local centers makes this pattern even clearer: Sinchon, Mapo/Gongdeok, Seongsu, Cheonho/Gildong, and Suseo/Munjeong are directly located inside upper-tier areas, while Dongdaemun and Sadang/Isu are adjacent to upper-tier areas. This shows the development-geography value that allows these areas to function as upper-tier districts.",
      "In practice, Gangnam among the 3 metropolitan centers functions as a core hub for Seoul's IT industry. Seoul's historic downtown serves as a center for international cultural exchange and tourism based on its historical status as the original city center, while also hosting major corporate headquarters. The Yeongdeungpo/Yeouido area functions as the core of finance in Seoul and, more broadly, in Korea. Among the 7 regional centers, Cheongnyangni/Wangsimni serves as an eastern Seoul rail-transport hub. Jamsil is the home base of Lotte Group and functions as a Seoul tourism destination through elements such as Lotte World Adventure Seoul and Lotte World Tower, while also emerging as a new center for Seoul's MICE industry. Yongsan is central to developing a new global business district through the redevelopment of the former Yongsan U.S. military base, and it also has political significance because it served as the presidential office during the Yoon Suk Yeol administration. Sangam/Susaek functions as a new hub for Korea's media and broadcasting industries, with headquarters and major offices such as MBC, JoongAng Ilbo/JTBC, and CJ ENM.",
      "From these points, upper-tier areas can be understood as sharing a common feature: strong accessibility to areas that function as hubs for specific industries. This suggests that accessibility to Seoul's major industrial hub districts influences the classification of upper-tier and lower-tier areas.",
      "There is also another notable feature in the districts highlighted as upper-tier areas: they are distributed along the Han River belt. Seocho, Gangnam, Songpa, and Gangdong south of the Han River, and Mapo, Yongsan, Seongdong, and Gwangjin north of the Han River, share a common trait: they are administrative districts located along the river. By contrast, districts in Seoul that are not connected to the Han River belt, such as Guro, Geumcheon, Gwanak, and Yangcheon south of the river and Jung, Jongno, Seodaemun, Dongdaemun, Jungnang, Eunpyeong, Seongbuk, Nowon, Dobong, and Gangbuk north of the river, share the opposite feature: they are not adjacent to the Han River belt. However, when considering areas such as Mapo, Yongsan, Seongdong, and Gwangjin, where prices can differ between complexes adjacent to the Han River and those that are not, it is necessary to be cautious about assigning special meaning to the Han River belt beyond recognizing it as a common feature.",
    ],
  },
};

const seoulGrowthUpperTierIds = [
  "gangnam",
  "seocho",
  "songpa",
  "mapo",
...
const seoulGrowthPlanTiers = {
  core: {
    ...
    points: [
      ...
      {
        name: { ko: "여의도·영등포", en: "Yeouido·Yeongdeungpo" },
        x: 36,
        y: 61,
      },
  ...
  metropolitan: {
    ...
    points: [
      ...
      {
        name: { ko: "청량리·왕십리", en: "Cheongnyangni·Wangsimni" },
        x: 62,
        y: 45,
      },
...
function syncGrdpDonutCopy(chart, lang) {
  const intro = ensureElementBefore(
    chart,
    ".chart-intro-text[data-grdp-donut-intro]",
    "p",
    (element) => {
  ...
  const analysis = ensureElementAfter(
    chart,
    ".grdp-donut-analysis[data-grdp-donut-analysis]",
    "div",
    (element) => {
...
function renderGrdpDonutCharts() {
  document.querySelectorAll("[data-grdp-donut-chart]").forEach((chart) => {
    ...
    const sectorTotal = grdpDonutData.items.reduce(
    ...
    const selectGrdpRegion = (regionId) => {
      ...
      if (isTotal) {
        ...
        detailMeta.textContent =
          lang === "ko" ? "전체 기준 100.0%" : "100.0% of total";
    ...
    chart.querySelectorAll("[data-grdp-region]").forEach((button) => {
      button.addEventListener("click", () =>
        selectGrdpRegion(button.dataset.grdpRegion),
      );
    });

    chart.querySelectorAll("[data-grdp-segment]").forEach((segmentPath) => {
      const activateSegment = () =>
        selectGrdpRegion(segmentPath.dataset.grdpSegment);
...
function syncComparisonIntro(chart, text) {
  const intro = ensureElementBefore(
    chart,
    ".chart-intro-text[data-comparison-intro]",
    "p",
    (element) => {
      element.className = "chart-intro-text";
...
function getComparisonValueText(value, lang, config, axis = false) {
  if (config.valueType === "count")
    return axis ? formatAxisCount(value, lang) : formatCount(value, lang);
...
function getComparisonGapText(gap, lang, config) {
  if (config.valueType === "count") {
    ...
    return lang === "ko"
      ? `${config.baseline[lang]} 대비 ${valueText} ${gap >= 0 ? "많습니다" : "적습니다"}.`
      : `${valueText} ${gap >= 0 ? "above" : "below"} the ${config.baseline[lang].toLowerCase()}.`;
  }
  const valueText = formatPrice(Math.abs(gap), lang);
  return lang === "ko"
    ? `지방 평균 대비 ${valueText} ${gap >= 0 ? "높습니다" : "낮습니다"}.`
    : `${valueText} ${gap >= 0 ? "above" : "below"} the local average.`;
}
...
function renderComparisonChart(chart, selectedId) {
  const lang = chart.dataset.lang || "en";
  const config =
    comparisonChartData[chart.dataset.comparisonType] ||
    comparisonChartData.capital;
  const selected =
...
function syncAcademyCountChart() {
  ...
  const localChart = sectionTitle.parentElement?.querySelector(
    '[data-comparison-chart][data-comparison-type="local"]',
  );
...
function formatVolume(value, lang) {
  ...
  return lang === "ko"
    ? `${Math.round(value).toLocaleString(locale)}건`
    : `${Math.round(value).toLocaleString(locale)} transactions`;
}
...
function formatAxisAreaPrice(value, lang) {
  const locale = lang === "ko" ? "ko-KR" : "en-US";
  return lang === "ko"
    ? `${Math.round(value).toLocaleString(locale)}만`
    : `${Math.round(value / 100).toLocaleString(locale)}M`;
}

function getTransactionPeriod(id) {
  return (
    transactionVolumeData.periods.find((period) => period.id === id) ||
    transactionVolumeData.periods[0]
  );
}
...
function getTransactionPolicyX(date, visibleMonths, paddingLeft, plotWidth) {
  ...
  const dayRatio =
    (Number(dayText) - 1) / getDaysInMonth(Number(yearText), Number(monthText));
...
function getPolicyMarkerColor(policy) {
  ...
  if (direction.includes("완화") || direction.includes("지원"))
    return "#2f5f95";
  return "#7b8794";
}
...
function getLineChartScale(values, scaleConfig) {
  if (scaleConfig.type === "zero") {
    const max =
      Math.ceil(
        (Math.max(...values) * scaleConfig.maxMultiplier) / scaleConfig.unit,
      ) * scaleConfig.unit;
  ...
  const paddedRange = Math.max(
    (rawMax - rawMin) * scaleConfig.rangeMultiplier,
    scaleConfig.minRange,
  );
  const step = Math.max(
    scaleConfig.unit,
    Math.ceil(paddedRange / 4 / scaleConfig.unit) * scaleConfig.unit,
  );
  const min = Math.max(
    0,
    Math.floor((rawMin - step * scaleConfig.paddingSteps) / step) * step,
  );
  const max =
    Math.ceil((rawMax + step * scaleConfig.paddingSteps) / step) * step;
...
function renderPolicyLineChart(container, lang, period, config) {
  ...
  const width = Math.max(
    config.minWidth,
    visibleMonths.length * config.monthWidth,
  );
  ...
  const xLabels = visibleMonths
    .map((month, index) => {
      ...
      const x =
        padding.left +
        (index / Math.max(visibleMonths.length - 1, 1)) * plotWidth;
  ...
  const paths = visibleSeries
    .map((series) => {
      const points = series.values.map((value, index) => {
        const x =
          padding.left +
          (index / Math.max(series.values.length - 1, 1)) * plotWidth;
        const y = padding.top + (1 - (value - min) / range) * plotHeight;
    ...
    .join("");
  const policyNodes = getTransactionPolicies(period)
    .map((policy, index) => {
      const x = getTransactionPolicyX(
        policy.date,
        visibleMonths,
        padding.left,
        plotWidth,
...
function renderTransactionVolumeChart(chart, selectedPeriodId = "all") {
  ...
  `;
  drawTransactionLineChart(
    chart.querySelector("[data-transaction-line-chart]"),
    lang,
    period,
  );
  updateOverflowingChoices(chart);
...
function renderAreaPriceChart(chart, selectedPeriodId = "all") {
  ...
  `;
  drawAreaPriceLineChart(
    chart.querySelector("[data-area-price-line-chart]"),
    lang,
    period,
  );
  updateOverflowingChoices(chart);
...
function initTransactionVolumeCharts() {
  document
    .querySelectorAll("[data-transaction-volume-chart]")
    .forEach((chart) => {
...
function syncRegulationTransactionChart() {
  ...
  const existingTransactionChart = section?.querySelector(
    "[data-transaction-volume-chart]",
  );
  const existingAreaPriceChart = section?.querySelector(
    "[data-area-price-chart]",
  );
  ...
  const transactionChart = ensureElementAfter(
    sectionTitle,
    "[data-transaction-volume-chart]",
    "div",
    (element) => {
  ...
  const areaPriceChart = ensureElementAfter(
    transactionChart,
    "[data-area-price-chart]",
    "div",
    (element) => {
...
function getPriceMapData(map) {
  ...
  if (map.dataset.mapType === "seoul")
    return data.filter((item) => item.id !== "seoul");
...
function getPriceBucketIndex(value, data) {
  ...
  return Math.min(
    pricePalette.length - 1,
    Math.floor(normalized * pricePalette.length),
  );
}
...
function renderMapLegend(map) {
  ...
  if (!isPriceView) {
    const regionLegend =
      map.dataset.mapType === "seoul" ? seoulRegionLegend : koreaRegionLegend;
    const items = regionLegend
      .map(
        (item) => `
  ...
  const items = pricePalette
    .map((color, index) => {
      const start = min + step * index;
      const end =
        index === pricePalette.length - 1 ? max : min + step * (index + 1);
      return `
      <span class="map-legend-item">
...
function colorMapSvg(map, selectedId) {
  ...
  Object.values(ids).forEach((svgId) => {
    ...
    const isSelected =
      selectedId === dataId || selectedMembers.includes(dataId);
    ...
    if (isGrowthPlanMap) {
      ...
      region.style.fill =
        showUpperTier && seoulGrowthUpperTierIds.includes(dataId)
          ? "#b8dbc3"
          : "#dedede";
    ...
    if (isPriceView && item) {
      ...
      region.style.opacity =
        isSelected || (isSeoulMap && selectedId === "seoul") ? "0.96" : "0.78";
      return;
    }
    ...
    if (isSeoulMap) {
      ...
      region.style.opacity =
        isSelected || selectedId === "seoul" ? "0.88" : "0.32";
      return;
    }
  ...
  const selectedRegion = selectedSvgId
    ? svg.querySelector(`#${selectedSvgId}`)
    : null;
...
function updateSeoulGrowthPlanDots(map) {
  ...
  const activeTiers = new Set(
    (map.dataset.activePlanTiers || "").split(",").filter(Boolean),
  );
...
function updateSeoulGrowthSwitchCopy(map) {
  ...
  label.textContent = isActive
    ? lang === "ko"
      ? "상급지 강조 끄기"
      : "Turn Off Upper-Tier Highlight"
    : lang === "ko"
      ? "상급지 강조 켜기"
      : "Turn On Upper-Tier Highlight";
}
...
function setupSeoulGrowthPlanMap(clonedHeatmap, lang) {
  ...
  clonedHeatmap
    .querySelectorAll(".map-source-note")
  ...
  const tierButtons = Object.entries(seoulGrowthPlanTiers)
    .map(
      ([id, tier]) => `
  ...
  regionList
    .querySelector("[data-upper-tier-switch]")
    ?.addEventListener("change", (event) => {
      map.dataset.upperTierHeatmap = event.currentTarget.checked
        ? "true"
        : "false";
...
function updateMapWidget(map, selectedId) {
  ...
  map.querySelectorAll(".map-region").forEach((button) => {
    ...
    const isActive =
      button.dataset.region === selected.id ||
      members.includes(button.dataset.region);
    button.classList.toggle("is-active", isActive);
    button.setAttribute("aria-pressed", String(isActive));
  });

  if (detail) {
    detail.querySelector("[data-map-cluster]").textContent =
      selected.cluster[lang];
    detail.querySelector("[data-map-name]").textContent = selected.name[lang];
    detail.querySelector("[data-map-price]").textContent = formatPrice(
      selected.price,
      lang,
    );
...
function inlineMapSvg(map) {
  ...
  return fetch(image.getAttribute("src"))
    .then((response) => {
      if (!response.ok)
        throw new Error(`Unable to load ${image.getAttribute("src")}`);
...
function initMapWidgets() {
  document
    .querySelectorAll("[data-map-widget], [data-korea-map]")
    .forEach((map) => {
      map.querySelectorAll(".map-region").forEach((button) => {
      ...
      map.addEventListener("click", (event) => {
        ...
        if (viewButton) {
          ...
          updateMapWidget(
            map,
            map.dataset.selectedRegion || map.dataset.defaultRegion || "seoul",
          );
          return;
        }
...
function syncSeoulGrowthSection() {
  ...
  const sourceHeatmap = Array.from(
    section.querySelectorAll(
      ".interactive-chart.heatmap-chart:not([data-seoul-growth-clone])",
    ),
  ...
  const followup = syncContentParagraphsAfter(
    lineChart,
    ".content[data-seoul-growth-followup]",
    [copy.afterTrend],
    (element) => {
  ...
  const planIntro = syncParagraphAfter(
    followup,
    "[data-seoul-plan-intro]",
    copy.planIntro,
    (element) => {
      element.className = "chart-intro-text";
  ...
  const clonedHeatmap = ensureCustomElementAfter(
    planIntro,
    "[data-seoul-growth-clone]",
    () => {
  ...
  syncContentParagraphsAfter(
    clonedHeatmap,
    "[data-seoul-plan-analysis]",
    copy.planAnalysis || [],
    (element) => {
